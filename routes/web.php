...
Route::get('/formEmpleado', ['as'=>'formEmpleado','uses'=>'EmpleadoController@getForm']);
Route::post('/postFormEmpleado', ['as'=>'postFormEmpleado','uses'=>'EmpleadoController@postForm']);
